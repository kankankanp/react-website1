  ...
  return (
    <ReactCardFlip isFlipped={isFlipped} flipDirection="horizontal">
      <div
        onClick={flipCard}
        className={
          "h-[400px] w-1/2 mx-auto rounded-3xl flex justify-around" +
          (icon === "" ? " hidden" : " block animate-fade-in-bottom") +
          bgChange()
        }
      >
        <div className="ml-14 *:text-center *:text-white flex items-center flex-col">
          <h2 className="px-12 border-b-2 border-white text-8xl mt-10 mb-8">
            {city}
          </h2>
          <ul>
